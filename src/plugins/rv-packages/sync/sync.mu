...
class: RemoteSync : MinorMode
{
    ...
    method: RemoteSync (RemoteSync; string name)
    {
        init (name,
                  ...
                  Menu {
                    {"Sync", Menu {
                        {"Open Network Dialog...", ~showNetworkDialog, nil, categoryState("")},
                        {"Copy Session URL", copySessionUrl, nil, categoryState("")},
                        {"_", nil, nil, nil},
                        {"Pull Session", pullSession, nil, categoryState("", checkOneContact)},
                        {"Push Session To All Contacts", pushSessionToAll, nil, categoryState("")},
                        {"_", nil, nil, nil},
                        {"Sync with Contacts' Contacts", toggleSyncWithContacts, nil, categoryState("", syncWithContactsState)},
                        {"Sync With Connected RVs", ~toggleSync, nil, categoryState("", syncWithConnectedRVsState)},
                        {"_", nil, nil, nil},
                        {"Settings", Menu {
                            {"Show Sync Messages", toggleFeedback, nil, categoryState("", feedbackState)},
                            {"Show Contacts Pointers", toggleShowContactsPointers, nil, categoryState("", showContactsPointersState)},
                            {"Show Pointer Trails", togglePointerTrails, nil, categoryState("", pointerTrailsState)},
                            {"Show Contacts Network Errors", toggleShowContactErrors, nil, categoryState("", showContactErrorsState)},
                            {"_", nil, nil, nil},
                            {"Send", nil, nil, \: (int;) { DisabledMenuState;} },
                            {"   Color", sendPattern (MatchColor,), nil, categoryState("", checkSendPattern (MatchColor))},
                            {"   Pan and Zoom", sendPattern (MatchViewTransform,), nil, categoryState("", checkSendPattern (MatchViewTransform))},
                            {"   Stereo Settings", sendPattern (MatchStereo,), nil, categoryState("", checkSendPattern (MatchStereo))},
                            {"   Annotation", sendPattern (MatchAnnotation,), nil, categoryState("", checkSendPattern (MatchAnnotation))},
                            {"   Media Changes", toggleSendMediaChanges, nil, categoryState("", checkSendMediaChanges)},
                            {"   Display Stereo Settings", sendPattern (MatchDisplayStereo,), nil, categoryState("", checkSendPattern (MatchDisplayStereo))},
                            {"   Display Color Settings", sendPattern (MatchDisplayColor,), nil, categoryState("", checkSendPattern (MatchDisplayColor))},
                            {"   Matte Settings", sendPattern (MatchSessionMatte,), nil, categoryState("", checkSendPattern (MatchSessionMatte))},
                            {"   Image Format Settings", sendPattern (MatchFormat,), nil, categoryState("", checkSendPattern (MatchFormat))},
                            {"   Audio Settings", sendPattern (MatchAudio,), nil, categoryState("", checkSendPattern (MatchAudio))},
                            {"   Pipeline Group Changes", Menu {
                                {"Linearize", sendPipelineGroup ("Linearize",), nil, categoryState("", checkSendPipelineGroup ("Linearize"))},
                                {"Color", sendPipelineGroup ("Color",), nil, categoryState("", checkSendPipelineGroup ("Color"))},
                                {"Look", sendPipelineGroup ("Look",), nil, categoryState("", checkSendPipelineGroup ("Look"))},
                                {"View", sendPipelineGroup ("View",), nil, categoryState("", checkSendPipelineGroup ("View"))},
                                {"Display", sendPipelineGroup ("Display",), nil, categoryState("", checkSendPipelineGroup ("Display"))},
                                {"General", sendPipelineGroup ("General",), nil, categoryState("", checkSendPipelineGroup ("General"))}}},
                            {"_", nil, nil, nil},
                            {"Accept", nil, nil, \: (int;) { DisabledMenuState;} },
                            {"   Color", acceptPattern (MatchColor,), nil, categoryState("", checkAcceptPattern (MatchColor))},
                            {"   Pan and Zoom", acceptPattern (MatchViewTransform,), nil, categoryState("", checkAcceptPattern (MatchViewTransform))},
                            {"   Stereo", acceptPattern (MatchStereo,), nil, categoryState("", checkAcceptPattern (MatchStereo))},
                            {"   Annotation", acceptPattern (MatchAnnotation,), nil, categoryState("", checkAcceptPattern (MatchAnnotation))},
                            {"   Media Changes", toggleAcceptMediaChanges, nil, categoryState("", checkAcceptMediaChanges)},
                            {"   Display Stereo Settings", acceptPattern (MatchDisplayStereo,), nil, categoryState("", checkAcceptPattern (MatchDisplayStereo))},
                            {"   Display Color Settings", acceptPattern (MatchDisplayColor,), nil, categoryState("", checkAcceptPattern (MatchDisplayColor))},
                            {"   Matte Settings", acceptPattern (MatchSessionMatte,), nil, categoryState("", checkAcceptPattern (MatchSessionMatte))},
                            {"   Image Format Settings", acceptPattern (MatchFormat,), nil, categoryState("", checkAcceptPattern (MatchFormat))},
                            {"   Audio Settings", acceptPattern (MatchAudio,), nil, categoryState("", checkAcceptPattern (MatchAudio))},
                            {"   Pipeline Group Changes", Menu {
                                {"Linearize", acceptPipelineGroup ("Linearize",), nil, categoryState("", checkAcceptPipelineGroup ("Linearize"))},
                                {"Color", acceptPipelineGroup ("Color",), nil, categoryState("", checkAcceptPipelineGroup ("Color"))},
                                {"Look", acceptPipelineGroup ("Look",), nil, categoryState("", checkAcceptPipelineGroup ("Look"))},
                                {"View", acceptPipelineGroup ("View",), nil, categoryState("", checkAcceptPipelineGroup ("View"))},
                                {"Display", acceptPipelineGroup ("Display",), nil, categoryState("", checkAcceptPipelineGroup ("Display"))},
                                {"General", acceptPipelineGroup ("General",), nil, categoryState("", checkAcceptPipelineGroup ("General"))}}},
                            {"_", nil, nil, nil},
                            {"Save as Default Settings", saveSettings, nil, categoryState("")}}},
                       {"_", nil, nil, nil},
                       {"Quit Sync", quitSync, nil, categoryState("")} }}}
                  ); 
