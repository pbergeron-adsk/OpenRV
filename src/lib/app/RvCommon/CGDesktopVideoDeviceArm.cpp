...
namespace Rv
{
    ...
    CGDesktopVideoDeviceArm::CGDesktopVideoDeviceArm(
        ...
        //        , TwkGLF::GLVideoDevice(m, "CoreGraphics",
        //        VideoDevice::ImageOutput)
        , m_display(display)
        , m_savedMode(nullptr)
        , m_savedScreen(0)
    {
    ...
    void CGDesktopVideoDeviceArm::redraw() const {}

    void CGDesktopVideoDeviceArm::redrawImmediately() const {}

    std::string CGDesktopVideoDeviceArm::hardwareIdentification() const
    {
