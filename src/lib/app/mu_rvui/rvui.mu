...
\: buildViewMenu (Menu;)
{
    Menu a = {
        {"Stereo", Menu {
            ...
            {"   Off", setStereo("off"), nil, categoryState("rendering", isStereo("off"))},
            {"   Anaglyph", setStereo("anaglyph"), nil, categoryState("rendering", isStereo("anaglyph"))},
            {"   Luminance Anaglyph", setStereo("lumanaglyph"), nil, categoryState("rendering", isStereo("lumanaglyph"))},
            {"   Side-by-Side", setStereo("pair"), nil, categoryState("rendering", isStereo("pair"))},
            {"   Mirror Side-by-Side", setStereo("mirror"), nil, categoryState("rendering", isStereo("mirror"))},
            //{"   Horizontal Squeezed", setStereo("hsqueezed"), nil, categoryState("rendering", isStereo("hsqueezed"))},
            //{"   Vertical Squeezed", setStereo("vsqueezed"), nil, categoryState("rendering", isStereo("vsqueezed"))},
            {"   DLP Checker", setStereo("checker"), nil, categoryState("rendering", isStereo("checker"))},
            {"   Scanline", setStereo("scanline"), nil, categoryState("rendering", isStereo("scanline"))},
            {"   Left Eye Only", setStereo("left"), nil, categoryState("rendering", isStereo("left"))},
            {"   Right Eye Only", setStereo("right"), nil, categoryState("rendering", isStereo("right"))},
            {"   Shutter Glasses", setStereo("hardware"), nil, categoryState("rendering", isStereo("hardware"))},
            {"_", nil},
            {"Global Swap Eyes", ~toggleSwapEyes, nil, categoryState("rendering", propToggledAndStereoOnState("@RVDisplayStereo.stereo.swap"))},
            {"Global Flip Right Eye", ~toggleRFlip, nil, categoryState("rendering", propToggledAndStereoOnState("@RVDisplayStereo.rightTransform.flip"))},
            {"Global Flop Right Eye", ~toggleRFlop, nil, categoryState("rendering", propToggledAndStereoOnState("@RVDisplayStereo.rightTransform.flop"))},
            {"_", nil},
            {"Interactive Edit",      nil, nil, inactiveState },
            {"    Global Relative Eye Offset (%)", stereoOffsetMode, nil, categoryState("rendering", eyeOffsetState)},
            {"    Global Right Eye Only Offset (%)", stereoROffsetMode, nil, categoryState("rendering", eyeOffsetState)},
            {"_", nil},
            {"Reset All Stereo Offsets", resetStereoOffsets, nil, categoryState("rendering", eyeOffsetState)},
            }},
        //{"Renderer", Menu {
        ...
        //  }},
        {"_", nil},
        {"Presentation Mode", ~togglePresentationMode, "control p", categoryState("presentation", presentationModeState)},
        {"Presentation Settings", Menu()},
        {"_", nil},
        {"Frame",           ~frameImage,     "f", categoryState("rendering", frameState)},
        {"Frame Width",     frameWidth,     "control f", categoryState("rendering", frameState)},
        {"_", nil},
        {"Linear to Display Correction", nil, nil, inactiveState},
        {"   No Correction", setDispConvert(""), nil, categoryState("rendering", hasDispConversion(""))},
        {"   sRGB", setDispConvert("sRGB"), nil, categoryState("rendering", hasDispConversion("sRGB"))},
        {"   Rec709", setDispConvert("Rec709"), nil, categoryState("rendering", hasDispConversion("Rec709"))},
        {"   Display Gamma 2.2", setDispConvert("Gamma 2.2"), nil, categoryState("rendering", hasDispConversion("Gamma 2.2"))},
        {"   Display Gamma 2.4", setDispConvert("Gamma 2.4"), nil, categoryState("rendering", hasDispConversion("Gamma 2.4"))},
        {"   Display Gamma...", enterDispGamma, "v", categoryState("rendering", dispGammaState)},
        {"_", nil},
        {"Display LUT Active", ~toggleDisplayLUT, "D", categoryState("rendering", isDisplayLUTActiveState)},
        {"Display ICC Active", ~toggleDisplayICC, "", categoryState("rendering", isDisplayICCActiveState)},
        {"_", nil},
        {"Display Brightness (Interactive)", brightnessMode, "B", categoryState("rendering", checkForDisplayColor())},
        {"_", nil},
        {"Matte", Menu {
            {"No Matte", ~setMatte(0),     nil, categoryState("rendering", matteAspectState(0))},
            {"1.33",     ~setMatte(1.33),  nil, categoryState("rendering", matteAspectState(1.33))},
            {"1.66",     ~setMatte(1.66),  nil, categoryState("rendering", matteAspectState(1.66))},
            {"1.77",     ~setMatte(1.77),  nil, categoryState("rendering", matteAspectState(1.77))},
            {"1.85",     ~setMatte(1.85),  nil, categoryState("rendering", matteAspectState(1.85))},
            {"2.35",     ~setMatte(2.35),  nil, categoryState("rendering", matteAspectState(2.35))},
            {"2.40",     ~setMatte(2.40),  nil, categoryState("rendering", matteAspectState(2.40))},
            {"_", nil},
            {"Custom...",    enterMatte,   nil, categoryState("rendering", matteAspectState(-1.0))}
        }},
        {"Matte Opacity", Menu {
            {"33%",     ~setMatteOpacity(0.33),  nil, categoryState("rendering", matteOpacityState(0.33))},
            {"66%",     ~setMatteOpacity(0.66),  nil, categoryState("rendering", matteOpacityState(0.66))},
            {"100%",    ~setMatteOpacity(1.0),   nil, categoryState("rendering", matteOpacityState(1.0))},
            {"_", nil},
            {"Custom...", enterMatteOpacity,   nil, categoryState("rendering", matteOpacityState(-1.0))}
        }},
        {"_", nil},
        {"Channel Display", Menu {
            {"Color (All Channels)", ~showChannel(0), "c", categoryState("rendering", channelState(0))},
            {"Red",             ~showChannel(1), "r", categoryState("rendering", channelState(1))},
            {"Green",           ~showChannel(2), "g", categoryState("rendering", channelState(2))},
            {"Blue",            ~showChannel(3), "b", categoryState("rendering", channelState(4))},
            {"_", nil},
            {"Luminance",       ~showChannel(5), "l", categoryState("rendering", channelState(5))}}},
        {"Channel Order", Menu {
            {"RGBA", ~channelOrder("RGBA"), nil, categoryState("rendering", channelOrderState("RGBA"))},
            {"_", nil},
            {"Custom...", enterOrder, nil, categoryState("rendering", checkForDisplayNode())},
            {"_", nil},
            {"RBGA", ~channelOrder("RBGA"), nil, categoryState("rendering", channelOrderState("RBGA"))},
            {"GBRA", ~channelOrder("GBRA"), nil, categoryState("rendering", channelOrderState("GBRA"))},
            {"GRBA", ~channelOrder("GRBA"), nil, categoryState("rendering", channelOrderState("GRBA"))},
            {"BRGA", ~channelOrder("BRGA"), nil, categoryState("rendering", channelOrderState("BRGA"))},
            {"BGRA", ~channelOrder("BGRA"), nil, categoryState("rendering", channelOrderState("BGRA"))},
            {"_", nil},
            {"ABGR", ~channelOrder("ABGR"), nil, categoryState("rendering", channelOrderState("ABGR"))},
            {"ARGB", ~channelOrder("ARGB"), nil, categoryState("rendering", channelOrderState("ARGB"))},
            {"_", nil},
            {"R00A", ~channelOrder("R00A"), nil, categoryState("rendering", channelOrderState("R00A"))},
            {"0G0A", ~channelOrder("0G0A"), nil, categoryState("rendering", channelOrderState("0G0A"))},
            {"00BA", ~channelOrder("00BA"), nil, categoryState("rendering", channelOrderState("00BA"))}
        }},
        {"Background", Menu {
            {"Black", setBGPattern(,"black"), nil,            categoryState("rendering", testBGPattern("black"))},
            {"18% Grey", setBGPattern(,"grey18"), nil,        categoryState("rendering", testBGPattern("grey18"))},
            {"50% Grey", setBGPattern(,"grey50"), nil,        categoryState("rendering", testBGPattern("grey50"))},
            {"White", setBGPattern(,"white"), nil,            categoryState("rendering", testBGPattern("white"))},
            {"Checker", setBGPattern(,"checker"), nil,        categoryState("rendering", testBGPattern("checker"))},
            {"Cross Hatch", setBGPattern(,"crosshatch"), nil, categoryState("rendering", testBGPattern("crosshatch"))}
        }},
        {"_", nil},
        {"Dither", Menu {
            {"Off", setDither(,0), nil, categoryState("rendering", testDither(0))},
            {"8 Bit", setDither(,8), nil, categoryState("rendering", testDither(8))},
            {"10 Bit", setDither(,10), nil, categoryState("rendering", testDither(10))}
        }},
        {"_", nil},
        {"Show Out Of Range Colors", ~toggleOutOfRange, nil, categoryState("rendering", isOutOfRange)},
        {"_", nil},
        {"Create/Edit Display Profiles...", ~editProfiles, nil, categoryState("rendering", displayProfilesState)},
        {"_", nil},
        {"Linear Filter",   ~toggleFilter, "n", categoryState("rendering", filterState)},
        {"Lock Pixel Scale During Resize",  toggleLockResizeScale, nil, categoryState("rendering", lockResizeScaleState)},
        {"Preserve Image Height in Pixel Aspect Scaling",  toggleExpandWidth, nil, categoryState("rendering", isExpandedWidth)}
    };
...
\: buildMainMenu (Menu; [MenuItem] userMenus = nil)
{
   ...
   Menu exportMenu = Menu {
            {"Quicktime Movie...", exportAs(, "mov", "Quicktime Export"), "control e", categoryState("export", videoSourcesExistAndExportOKState)},
            {"Image Sequence...", exportAs(, "*", "Image Sequence Export"), nil, categoryState("export", videoSourcesExistAndExportOKState)},
            {"Marked Frames...", exportMarked, nil, categoryState("export", hasMarksState)},
            {"Annotated Frames...", exportAnnotatedFrames, nil, categoryState("export", videoSourcesExistState)},
            {"Audio File...", exportAs(, "*", "Audio Export"), nil, categoryState("export", sourcesExistState)},
            {"Snapshot...", exportFrame(,exportCurrentFrame), nil, categoryState("export", videoSourcesExistState)},
            {"Current Source Frame...", exportFrame(,exportCurrentSourceFrame), nil, categoryState("export", videoSourcesExistState)},
            {"Image Attributes...", exportAttrs, nil, categoryState("export", videoSourcesExistState)},
            {"RVIO Ready Session...", exportAs(, "rv", "Session Export"), nil, categoryState("export", videoSourcesExistState)},
            {"OTIO File...", exportOtio, nil, categoryState("export", canExportOTIOState)}};

    if (true || shortAppName() == "rvx")
    {
         exportMenu.push_back (MenuItem {"Definition of Current View Node ...", exportNodeDefinition(false,), nil, categoryState("export", videoSourcesExistState)});
         exportMenu.push_back (MenuItem {"All Node Definitions ...", exportNodeDefinition(true,), nil, categoryState("export", videoSourcesExistState)});
    }

    Menu mainMenu_part1 = {
        {"File", Menu {
            {"New Session", \: (void; Event ev) { newSession(nil); }, "control n", categoryState("media", newSessionState)},
            {"Open...",  addMovieOrImageSources(,true,false), "control o", categoryState("media")},
            {"Merge...",  addMovieOrImageSources(,true,true), nil, categoryState("media")},
            {"Open into Layer...",  addMovieOrImage(,addToClosestSource(,"explicit"),false), nil, categoryState("media", sourcesExistState)},
            {"Open in New Session...",  openMovieOrImage, "control O", categoryState("media", newSessionState)},
            {"_", nil},
            {"Clone Session", cloneSession, nil, categoryState("media", newSessionState)},
            {"Clone RV", cloneRV, nil, categoryState("media")},
            {"Clone Synced RV", cloneSyncedRV, nil, categoryState("media")},
            {"_", nil},
            {"Relocate Movie or Image Sequence...",  relocateMovieOrImage, nil, categoryState("media", singleSourceState)},
            {"Replace Source Media...", replaceSourceMedia, nil, categoryState("media", singleSourceState)},
            {"_", nil},
            {"Save Session", save, "control s", categoryState("export")},
            {"Save Session As...", saveAs, "control S", categoryState("export")},
            {"_", nil},
            {"Import", Menu {
                {"Display LUT...",  openLUTFile("@RVDisplayColor"), nil, categoryState("media", checkForDisplayColor())},
                {"Pre-Cache LUT...",  openLUTFile("#RVCacheLUT"), nil, categoryState("media", videoSourcesAndNodeExistState("RVCacheLUT"))},
                {"File LUT...",  openLUTFile("#RVLinearize"), nil, categoryState("media", videoSourcesAndNodeExistState("RVLinearize"))},
                {"File CDL...",  openCDLFile("#RVLinearize"), nil, categoryState("media", videoSourcesAndNodeExistState("RVLinearize"))},
                {"Look LUT...",  openLUTFile("#RVLookLUT"), nil, categoryState("media", videoSourcesAndNodeExistState("RVLookLUT"))},
                {"Look CDL...",  openCDLFile("#RVColor"), nil, categoryState("media", videoSourcesAndNodeExistState("RVColor"))},
                {"File OTIO...",  openOTIOFile(), nil, categoryState("media", checkForOTIOFile())},
                {"Simple EDL...",  ~openSimpleEDL, nil, categoryState("media")}}},
            {"Export", exportMenu},
            {"_", nil},
            {"Clear",           ~clearEverything, "control N", categoryState("media")},
            {"Close Session",    queryClose, "control w", categoryState("exit")}
            }},
        {"Edit", Menu {
            ...
            //{"_", nil},
            {"Mark Frame",               ~toggleMark,    "m",   categoryState("mark", markedState)},
            {"Mark Sequence Boundaries", ~markSequence,  nil,   categoryState("mark", sequenceState)},
            {"Mark Annotated Frames", ~markAnnotatedFrames,  nil,   categoryState("mark", rangeState)},
            {"Clear All Marks",          ~clearAllMarks, nil,   categoryState("mark", hasMarksState)},
            {"Mark in Range", Menu {
                {"Clear Range",          ~clearMarksInRange,  nil,     categoryState("mark", hasMarksState)},
                {"_", nil},
                {"Set Range In Point",    ~frameFunc(setInPoint),   "[", categoryState("mark", rangeState)},
                {"Set Range Out Point",   ~frameFunc(setOutPoint),  "]", categoryState("mark", rangeState)},
                {"Reset Range",            ~resetInOutPoints,  "\\",     categoryState("mark", rangeState)},
                /*
                {"_", nil},
                ...
                */
                {"_", nil},
                {"Set Range From Marks/Boundaries",  ~setInOutMarkedRange, "|",      categoryState("mark", rangeState)},
                {"Next Range From Marks/Boundaries", ~nextMarkedRange, "control right", categoryState("mark", rangeState)},
                {"Prev Range From Marks/Boundaries", ~previousMarkedRange, "control left", categoryState("mark", rangeState)},
                {"Expand Range From Marks/Boundaries", ~expandMarkedRange, "control up", categoryState("mark", rangeState)},
                {"Contract Range From Marks/Boundaries", ~contractMarkedRange, "control down", categoryState("mark", rangeState)}}},
            {"Set Range Offset", setRangeOffset, nil, categoryState("mark", sourcesExistState)},
            }},
        {"Control", Menu {
            {"Play",            ~togglePlayFunc,     nil, categoryState("transport", playState)},
            {"Stop",            ~stopFunc,           nil, categoryState("transport", rangeState)},
            {"PingPong",        ~togglePingPong, nil, categoryState("transport", pingPongState)},
            {"Play Once",       ~togglePlayOnce, nil, categoryState("transport", playOnceState)},
            {"Step Forward",    ~stepForward1,   nil, categoryState("transport", rangeState)},
            {"Step Backward",   ~stepBackward1,  nil, categoryState("transport", rangeState)},
            {"Reverse",         ~toggleForwardsBackwards, nil, categoryState("transport", rangeState)},
            {"_", nil},
            {"Go To Frame...",   enterFrame, "G",  categoryState("transport", rangeState)},
            {"_", nil},
            {"Play All Frames", ~toggleRealtime, "A",           categoryState("transport", realtimeState)},
                {"FPS", Menu {
                    {"24",       ~setFPSFunc(24.0),  "alt 2",   categoryState("media", rangeState)},
                    {"25",       ~setFPSFunc(25.0),  "alt 5",   categoryState("media", rangeState)},
                    {"23.98",    ~setFPSFunc(23.98),  nil,          categoryState("media", rangeState)},
                    {"30",       ~setFPSFunc(30.0),  "alt 3",   categoryState("media", rangeState)},
                    {"29.97",    ~setFPSFunc(29.97),  nil,          categoryState("media", rangeState)},
                    {"_", nil},
                    {"Custom...", enterFPS,           "F",          categoryState("media", rangeState)}}},
            {"_", nil},
            {"Play Forward",    ~incN(1),       ".",            categoryState("transport", forwardState)},
            {"Play Backward",   ~incN(-1),      ",",            categoryState("transport", backwardState)},
            {"_", nil},
            {"Jump To Beginning", ~beginning,           "home",         categoryState("transport", rangeState)},
            {"Jump To Ending",    ~ending,              "end",          categoryState("transport", rangeState)},
            {"Next Marked Frame", ~nextMarkedFrame,     "alt right", categoryState("mark", rangeState)},
            {"Prev Marked Frame", ~previousMarkedFrame, "alt left", categoryState("mark", rangeState)},
            {"Matching Frame Of Next Source", ~nextMatchedFrame,     ">", categoryState("mark", rangeState)},
            {"Matching Frame Of Previous Source", ~previousMatchedFrame, "<", categoryState("mark", rangeState)},
            /*  
             * Moved to prefs GUI
             *
            {"_", nil},
        ...
        {"Tools", Menu {
            ...
            {"   Sequence", setCompModeAndView(nil,"defaultSequence"), nil, categoryState("rendering", viewNodeState("defaultSequence"))},
            {"   Replace", setCompModeAndView("replace","defaultStack"), nil, categoryState("rendering", isStackAndCompMode("replace"))},
            {"   Over", setCompModeAndView("over","defaultStack"), nil, categoryState("rendering", isStackAndCompMode("over"))},
            {"   Add", setCompModeAndView("add","defaultStack"), nil, categoryState("rendering", isStackAndCompMode("add"))},
            //{"   Dissolve", setCompModeAndView("difference","defaultStack"), nil, categoryState("rendering", isStackAndCompMode("dissolve"))}, 
            {"   Difference", setCompModeAndView("difference","defaultStack"), nil, categoryState("rendering", isStackAndCompMode("difference"))}, 
            {"   Difference (Inverted)", setCompModeAndView("-difference","defaultStack"), nil, categoryState("rendering", isStackAndCompMode("-difference"))},
            //{"   Picture in Picture", setCompModeAndView("pip","defaultStack"), nil, categoryState("rendering", isStackAndCompMode("pip"))},
            {"   Tile", setCompModeAndView(nil,"defaultLayout"), nil, categoryState("rendering", viewNodeState("defaultLayout"))},
            {"_", nil},
            {"Timeline",        ~toggleTimeline, "F2", categoryState("timeline", timelineShown)},
            {"Timeline Magnifier", ~toggleMotionScope, "F3", categoryState("timeline", motionScopeShown)},
            {"Image Info",      ~toggleInfo,     "F4", categoryState("info", infoShown)},
            {"Color Inspector", ~toggleColorInspector, "F5", categoryState("info", colorInspectorShown)},
            {"Wipes",           ~toggleWipe, "F6", categoryState("rendering", wipeShown)},
            {"Info Strip",      ~toggleInfoStrip, "F7", categoryState("info", infoStripShown)},
            {"Process Info",    ~toggleProcessInfo, "F8", categoryState("info", processInfoShown)},
            {"Source Details",  ~toggleSourceDetails, "F11", categoryState("info", sourceDetailsShown)},
            {"_", nil},
            {"Menu Bar",        ~toggleMenuBar,  "F1", categoryState("menubar", menuBarShown)},
            {"Top View Toolbar",    toggleTopViewToolbar,  nil, categoryState("topbar", topTBShown)},
            {"Bottom View Toolbar", toggleBottomViewToolbar,  nil, categoryState("bottombar", botTBShown)},
            {"_", nil},
            {"Force Reload Current Frame", ~reload, "R", categoryState("media", sourcesExistState)},
            {"Force Reload Region", ~reloadInOut, "control R", categoryState("media", sourcesExistState)},
            {"Reload Changed Frames", ~loadCurrentSourcesChangedFrames, "control C", categoryState("media", sourcesExistState)},
            {"_", nil},
            {"Cache Mode",  nil,  nil, inactiveState},
            {"   Look-Ahead Cache", cacheModeFunc(CacheBuffer), "control l", categoryState("performance", cacheStateFunc(CacheBuffer))},
            {"   Region Cache",  cacheModeFunc(CacheGreedy), "C", categoryState("performance", cacheStateFunc(CacheGreedy))},
            {"   Cache Off", cacheModeFunc(CacheOff),  nil, categoryState("performance", cacheStateFunc(CacheOff))},
            {"   Release All Cached Images", ~releaseAllCachedImages,  nil, categoryState("performance")},
            {"_", nil},
            {"Diagnostics",    showDiagnosticsWindow, nil, categoryState("diagnostics")},
            {"_", nil},
            }},
        {"Audio", Menu {
            {"Mute", ~toggleMute, nil, categoryState("audio", isMuted)},
            {"Scrubbing", toggleAudioScrub, nil, categoryState("audio", scrubAudioState)},
            {"_", nil},
            {"Global",  nil,  nil, inactiveState},
            {"   Volume",  globalVolumeMode,     "control v", categoryState("audio")},
            {"   Offset (seconds)",  globalAudioOffsetMode, nil, categoryState("audio")},
            {"   Offset (frames)",  globalAudioOffsetFramesMode, nil, categoryState("audio")},
            {"   Balance", globalBalanceMode,   nil, categoryState("audio")},
            {"Source",  nil,  nil, inactiveState},
            {"   Volume", sourceVolumeMode, nil, categoryState("media", sourcesExistState)},
            {"   Offset (seconds)", sourceAudioOffsetMode, nil, categoryState("media", sourcesExistState)},
            {"   Offset (frames)",  sourceAudioOffsetFramesMode, nil, categoryState("media", sourcesExistState)},
            {"   Balance", sourceBalanceMode,   nil, categoryState("media", sourcesExistState)},
            {"_", nil},
            {"   Reset All Offsets", resetAudioOffsets, nil, categoryState("media")},
        }},
        {"Image", Menu {
                {"Color Resolution", Menu {
                    {"Allow Floating Point", ~toggleFloat, nil, categoryState("rendering", isFloatAllowed)},
                    {"_", nil},
                    {"Maximum Allowed", ~setBitDepthFunc(0), nil, categoryState("rendering", bitDepthState(0))},
                    {"8", ~setBitDepthFunc(8), nil, categoryState("rendering", bitDepthState(8))},
                    {"16", ~setBitDepthFunc(16), nil, categoryState("rendering", bitDepthState(16))},
                    {"32", ~setBitDepthFunc(32), nil, categoryState("rendering", bitDepthState(32))}}},
                {"Image Resolution", Menu {
                    {"1.0",  ~setImageResolution(1.0), nil, categoryState("rendering", imageResState(1.0))},
                    {"0.5",  ~setImageResolution(0.5), nil, categoryState("rendering", imageResState(0.5))},
                    {"0.25", ~setImageResolution(0.25), nil, categoryState("rendering", imageResState(0.25))},
                    {"_", nil},
                    {"Custom...", enterRes, nil, categoryState("rendering", videoSourcesAndNodeExistState("RVFormat"))}}},
                {"Scale", Menu {
                    {"1:1",  ~pixelRelativeScale(1.0),  "1", categoryState("rendering", videoSourcesExistState)},
                    {"_", nil},
                    {"2:1",  ~pixelRelativeScale(2.0),  "2", categoryState("rendering", videoSourcesExistState)},
                    {"4:1",  ~pixelRelativeScale(4.0),  "4", categoryState("rendering", videoSourcesExistState)},
                    {"8:1",  ~pixelRelativeScale(8.0),  "8", categoryState("rendering", videoSourcesExistState)},
                    {"_", nil},
                    {"1:2",  ~pixelRelativeScale(1.0/2.0),  "control 2", categoryState("rendering", videoSourcesExistState)},
                    {"1:4",  ~pixelRelativeScale(1.0/4.0),  "control 4", categoryState("rendering", videoSourcesExistState)},
                    {"1:8",  ~pixelRelativeScale(1.0/8.0),  "control 8", categoryState("rendering", videoSourcesExistState)}}},
                {"Rotation", Menu {
                    {"No Rotation",         ~rotateImage(0.0, false),    nil, categoryState("rendering", rotateState(0.0))},
                    {"90 Clockwise",        ~rotateImage(90.0, false),   nil, categoryState("rendering", rotateState(90.0))},
                    {"90 Counter-Clockwise",~rotateImage(-90.0, false),  nil, categoryState("rendering", rotateState(-90.0))},
                    {"180",                 ~rotateImage(180.0, true),  nil, categoryState("rendering", rotateState(180.0))},
                    {"_", nil},
                    {"+90 Clockwise",        ~rotateImage(90.0, true),   nil, categoryState("rendering", videoSourcesAndNodeExistState("RVTransform2D"))},
                    {"+90 Counter-Clockwise",~rotateImage(-90.0, true),  nil, categoryState("rendering", videoSourcesAndNodeExistState("RVTransform2D"))},
                    {"_", nil},
                    {"Arbitrary (Rotate Mode)", rotateMode,   nil, categoryState("rendering", videoSourcesAndNodeExistState("RVTransform2D"))}}},
                {"Alpha Type", Menu {
                    {"From Image",  ~alphaTypeFunc(0),  nil, categoryState("rendering", alphaTypeState(0))},
                    {"_", nil},
                    {"Unpremultiplied",  ~alphaTypeFunc(2),  nil, categoryState("rendering", alphaTypeState(2))},
                    {"Premultiplied",  ~alphaTypeFunc(1),  nil, categoryState("rendering", alphaTypeState(1))}}},
                {"Pixel Aspect Ratio", Menu {
                    {"From Image",  ~pixelAspectFunc(0.0),  nil, categoryState("rendering", aspectState(0.0))},
                    {"_", nil},
                    {"Square",  ~pixelAspectFunc(1.0),  nil, categoryState("rendering", aspectState(1.0))},
                    {"NTSC D1 DV  4:3",  ~pixelAspectFunc(0.9),  nil, categoryState("rendering", aspectState(0.9))},
                    {"NTSC D1 DV  16:9", ~pixelAspectFunc(1.2), nil, categoryState("rendering", aspectState(1.2))},
                    {"PAL  4:3",         ~pixelAspectFunc(1.06666),  nil, categoryState("rendering", aspectState(1.0666))},
                    {"PAL  16:9",        ~pixelAspectFunc(1.422), nil, categoryState("rendering", aspectState(1.422))},
                    {"Anamorphic  2:1",  ~pixelAspectFunc(2.0), nil, categoryState("rendering", aspectState(2.0))},
                    {"_", nil},
                    {"Custom...", enterPixAspect, nil, categoryState("rendering", videoSourcesAndNodeExistState("RVLensWarp"))}}},
                {"Stereo", Menu {
                    {"Swap Eyes", ~toggleSourceSwapEyes, nil, categoryState("rendering", propToggledAndStereoOnState("#RVSourceStereo.stereo.swap"))},
                    {"Flip Right Eye", ~toggleSourceRFlip, nil, categoryState("rendering", propToggledAndStereoOnState("#RVSourceStereo.rightTransform.flip"))},
                    {"Flop Right Eye", ~toggleSourceRFlop, nil, categoryState("rendering", propToggledAndStereoOnState("#RVSourceStereo.rightTransform.flop"))},
                    {"_", nil},
                    {"Interactive Edit",      nil, nil, inactiveState },
                    {"    Relative Eye Offset (%)", sourceStereoOffsetMode, nil, categoryState("rendering", eyeOffsetState)},
                    {"    Right Eye Only Offset (%)", sourceStereoROffsetMode, nil, categoryState("rendering", eyeOffsetState)},
                    }},
            {"_", nil},
            {"Flip",            ~toggleFlip, "Y", categoryState("rendering", toggleFlipState)},
            {"Flop",            ~toggleFlop, "X", categoryState("rendering", toggleFlopState)},
            {"_", nil},
            {"Remap Source Image Channels...", enterChanMap, nil, categoryState("rendering", videoSourcesAndNodeExistState("RVChannelMap"))},
            {"_", nil},
            {"Set Source FPS...", enterSourceFPS, nil, categoryState("media", sourcesExistState)},
            {"_", nil},
            {"Cycle Stack Forward", cycleStackForward, ")", categoryState("tbd", isStackMode)},
            {"Cycle Stack Backward", cycleStackBackward, "(", categoryState("tbd", isStackMode)}
            }},
        {"Color", Menu {
                {"Luminance Look Up Table", Menu {
                    {"Active",   ~toggleLuminanceLUT, "T", categoryState("rendering", isLuminanceLUTActiveState)},
                    {"_", nil},
                    {"Luminance LUTS", nil, nil, inactiveState},
                    {"   HSV ",   ~HSVLUT,    nil, categoryState("rendering", luminanceLUTState("HSV"))},
                    {"   Contour 3",   ~contourLUT(3),    nil, categoryState("rendering", luminanceLUTState("Contour 3"))},
                    {"   Contour 4",   ~contourLUT(4),    nil, categoryState("rendering", luminanceLUTState("Contour 4"))},
                    {"   Contour 6",   ~contourLUT(6),    nil, categoryState("rendering", luminanceLUTState("Contour 6"))},
                    {"   Contour 10",   ~contourLUT(10),    nil, categoryState("rendering", luminanceLUTState("Contour 10"))},
                    {"   Contour 20",   ~contourLUT(20),    nil, categoryState("rendering", luminanceLUTState("Contour 20"))},
                    {"   Contour 100",   ~contourLUT(100),  nil, categoryState("rendering", luminanceLUTState("Contour 100"))},
                    {"   Random",   ~randomLUT,  "*", categoryState("rendering", luminanceLUTState("Random"))}}},
                    //
            ...
            {"   No Conversion",    setLinConvert(""), nil, categoryState("rendering", hasLinConversion(""))},
            {"   Cineon/DPX Log",   setLinConvert("Cineon Log"), "L", categoryState("rendering", hasLinConversion("Cineon Log"))},
            {"   ALEXA LogC",       setLinConvert("ALEXA LogC"), nil, categoryState("rendering", hasLinConversion("ALEXA LogC"))},
            {"   ALEXA LogC Film",  setLinConvert("ALEXA LogC Film"), nil, categoryState("rendering", hasLinConversion("ALEXA LogC Film"))},
            //{"   SONY S-Log",       setLinConvert("SONY S-Log"), nil, categoryState("rendering", hasLinConversion("SONY S-Log"))},
            {"   Viper Log",        setLinConvert("Viper Log"), nil, categoryState("rendering", hasLinConversion("Viper Log"))},
            {"   Red Log",          setLinConvert("Red Log"), nil, categoryState("rendering", hasLinConversion("Red Log"))},
            {"   Red Log Film",     setLinConvert("Red Log Film"), nil, categoryState("rendering", hasLinConversion("Red Log Film"))},
            {"   sRGB",             setLinConvert("sRGB"), nil, categoryState("rendering", hasLinConversion("sRGB"))},
            {"   Rec709",           setLinConvert("Rec709"), nil, categoryState("rendering", hasLinConversion("Rec709"))},
            {"   File Gamma 2.2",        setLinConvert("Gamma 2.2"), nil, categoryState("rendering", hasLinConversion("Gamma 2.2"))},
            {"   File Gamma...",         enterFileGamma, nil, categoryState("rendering", fileGammaState)},
            {"_", nil},
            {"Pre-Cache LUT", ~toggleCacheLUT, nil, categoryState("rendering", isCacheLUTActiveState)},
            {"File LUT",      ~toggleFileLUT, nil, categoryState("rendering", isFileLUTActiveState)},
            {"File CDL",      ~toggleFileCDL, nil, categoryState("rendering", isFileCDLActiveState)},
            {"File ICC",      ~toggleFileICC, nil, categoryState("rendering", isFileICCActiveState)},
            {"Look LUT",      ~toggleLookLUT, nil, categoryState("rendering", isLookLUTActiveState)},
            {"Look CDL",      ~toggleLookCDL, nil, categoryState("rendering", isLookCDLActiveState)},
            {"_", nil},
            {"Invert", ~toggleInvert, "I", categoryState("rendering", isInvert)},
            //  RVHistogram node deprecated to remove from GUI for now
            //{"Normalize", toggleNormalizeColor, nil, categoryState("rendering", isNormalizingColor)},
            {"_", nil},
            {"Interactive Edit",      nil, nil, inactiveState },
            {"    Gamma",      gammaMode,      "y", categoryState("rendering", videoSourcesAndNodeExistState("RVColor"))},
            {"    Color Offset", colorOffsetMode,  nil,  categoryState("rendering", videoSourcesAndNodeExistState("RVColor"))},
            {"    Exposure",   exposureMode,   "e", categoryState("rendering", videoSourcesAndNodeExistState("RVColor"))},
            {"    Saturation", saturationMode, "S", categoryState("rendering", videoSourcesAndNodeExistState("RVColor"))},
            {"    Hue",        hueMode,        "h", categoryState("rendering", videoSourcesAndNodeExistState("RVColor"))},
            {"    Contrast",   contrastMode,   "k", categoryState("rendering", videoSourcesAndNodeExistState("RVColor"))},
            {"_", nil},
            {"Range", Menu {
                {"From Image", ~setColorSpaceAttr("Range","From Image"), nil, categoryState("rendering", matchesColorSpaceAttr("Range","From Image"))},
                {"_", nil},
                {"Video Range", ~setColorSpaceAttr("Range","Video Range"), nil, categoryState("rendering", matchesColorSpaceAttr("Range","Video Range"))},
                {"Full Range", ~setColorSpaceAttr("Range","Full Range"), nil, categoryState("rendering", matchesColorSpaceAttr("Range","Full Range"))}}},
            {"_", nil},
            {"Ignore File Primaries", ~toggleChromaticities, nil, categoryState("rendering", isIgnoringChromaticies)},
            {"Reset All Color", ~resetAllColorParameters, "shift Home", categoryState("rendering", videoSourcesAndNodeExistState("RVColor"))}
            }},
        {"View", buildViewMenu() }
...
\: defineDefaultBindings (void;)
{
    ...
    bind("user-active", categoryAction("tbd", setActiveState));
    bind("user-inactive", categoryAction("tbd", setInactiveState));
    ...
    bind("key-down-- ", categoryAction("transport", togglePlayFunc), "Toggle Play");
    bind("key-down--(", categoryAction("tbd", cycleStackBackward), "Cycle Image Stack Backwards");
    bind("key-down--)", categoryAction("tbd", cycleStackForward), "Cycle Image Stack Forwards");
    bind("key-down--*", categoryAction("rendering", randomLUT), "Apply Random Luminance LUT");
    bind("key-down--,", categoryAction("transport", incN(-1)), "Set Frame Increment to -1 (reverse)");
    bind("key-down--.", categoryAction("transport", incN(1)), "Set Frame Increment to 1 (forward)");
    bind("key-down--1", categoryAction("rendering", pixelRelativeScale(1.0)), "Scale 1:1");
    bind("key-down--2", categoryAction("rendering", pixelRelativeScale(2.0)), "Scale 2:1");
    bind("key-down--3", categoryAction("rendering", pixelRelativeScale(3.0)), "Scale 3:1");
    bind("key-down--4", categoryAction("rendering", pixelRelativeScale(4.0)), "Scale 4:1");
    bind("key-down--5", categoryAction("rendering", pixelRelativeScale(5.0)), "Scale 5:1");
    bind("key-down--6", categoryAction("rendering", pixelRelativeScale(6.0)), "Scale 6:1");
    bind("key-down--7", categoryAction("rendering", pixelRelativeScale(7.0)), "Scale 7:1");
    bind("key-down--8", categoryAction("rendering", pixelRelativeScale(8.0)), "Scale 8:1");
    bind("key-down--A", categoryAction("transport", toggleRealtime), "Toggle Real-Time Playback");
    bind("key-down--C", categoryAction("performance", toggleCacheModeFunc(CacheGreedy)), "Toggle Region Caching");
    bind("key-down--D", categoryAction("rendering", toggleDisplayLUT), "Toggle Display LUT");
    bind("key-down--F", categoryAction("media", enterFPS), "Enter FPS Value From Keyboard");
    bind("key-down--G", categoryAction("transport", enterFrame), "Set Frame Number Using Keyboard");
    bind("key-down--I", categoryAction("rendering", toggleInvert), "Toggle Color Invert");
    bind("key-down--L", categoryAction("rendering", setLinConvert("Cineon Log")), "Toggle Cineon Log to Linear Conversion");
    bind("key-down--M", categoryAction("rendering", cycleMatteOpacity), "Cycle Matte Opacity");
    bind("key-down--P", categoryAction("transport", togglePingPong), "Toggle Ping/Pong Playback");
    bind("key-down--R", categoryAction("media", ~reload), "Force Reload of Current Source");
    bind("key-down--T", categoryAction("rendering", toggleLuminanceLUT), "Toggle Current Luminance LUT");
    bind("key-down--X", categoryAction("rendering", toggleFlop), "Flop Image");
    bind("key-down--Y", categoryAction("rendering", toggleFlip), "Flip Image");
    bind("key-down--[", categoryAction("mark", frameFunc(setInPoint)), "Set In Point");
    bind("key-down--\\", categoryAction("mark", resetInOutPoints), "Reset In/Out Points");
    bind("key-down--]", categoryAction("mark", frameFunc(setOutPoint)), "Set Out Point");
    bind("key-down--a", categoryAction("rendering", showChannel(4)), "Show Alpha Channel");
    bind("key-down--b", categoryAction("rendering", showChannel(3)), "Show Blue Channel");
    bind("key-down--c", categoryAction("rendering", showChannel(0)), "Normal Color Channel Display");
    bind("key-down--alt--l", categoryAction("rendering", ~rotateImage(-90, true)), "Rotate Image 90deg Counter-Clockwise");
    bind("key-down--alt--r", categoryAction("rendering", ~rotateImage(90, true)), "Rotate Image 90deg Clockwise");
    bind("key-down--alt--left", categoryAction("mark", previousMarkedFrame), "Go to Previous Marked Frame");
    bind("key-down--alt--right", categoryAction("mark", nextMarkedFrame), "Go to Next Marked Frame");
    bind("key-down--<", categoryAction("transport", previousMatchedFrame), "Go to Matching Frame of Previous Source");
    bind("key-down-->", categoryAction("transport", nextMatchedFrame), "Go to Matching Frame of Next Source");
    bind("key-down--shift--left", categoryAction("navigation", prevView), "Go to Previous View");
    bind("key-down--shift--right", categoryAction("navigation", nextView), "Go to Next View");
    bind("key-down--control--e", categoryAction("export", exportAs(, "mov", "Quicktime Export")), "Export Quicktime Movie");
    bind("key-down--control--q", categoryAction("exit", queryClose), "Close Session");
    bind("key-down--control--N", categoryAction("media", clearEverything), "Clear Session");
    bind("key-down--control--S", categoryAction("export", saveAs), "Save Session As");
    bind("key-down--control--i", categoryAction("media", addMovieOrImageSources(,true,false)), "Add Source");
    bind("key-down--control--s", categoryAction("export", save), "Save Session");
    bind("key-down--control--w", categoryAction("exit", queryClose), "Close Session");
    bind("key-down--control--o", categoryAction("media", addMovieOrImageSources(,true,false)), "Open File");
    bind("key-down--control--O", categoryAction("media", openMovieOrImage), "Open in New Session");
    bind("key-down--control--1", categoryAction("rendering", pixelRelativeScale(1.0/1.0)), "Scale 1:1");
    bind("key-down--control--2", categoryAction("rendering", pixelRelativeScale(1.0/2.0)), "Scale 1:2");
    bind("key-down--control--3", categoryAction("rendering", pixelRelativeScale(1.0/3.0)), "Scale 1:3");
    bind("key-down--control--4", categoryAction("rendering", pixelRelativeScale(1.0/4.0)), "Scale 1:4");
    bind("key-down--control--5", categoryAction("rendering", pixelRelativeScale(1.0/5.0)), "Scale 1:5");
    bind("key-down--control--6", categoryAction("rendering", pixelRelativeScale(1.0/6.0)), "Scale 1:6");
    bind("key-down--control--7", categoryAction("rendering", pixelRelativeScale(1.0/7.0)), "Scale 1:7");
    bind("key-down--control--8", categoryAction("rendering", pixelRelativeScale(1.0/8.0)), "Scale 1:8");
    bind("key-down--control--l", categoryAction("performance", toggleCacheModeFunc(CacheBuffer)), "Toggle Look-Ahead Caching");
    bind("key-down--control--m", categoryAction("rendering", cycleMatte), "Cycle Mattes");
    bind("key-down--control--left", categoryAction("mark", previousMarkedRange), "Set In/Out to Previous Marked Range");
    bind("key-down--control--right", categoryAction("mark", nextMarkedRange), "Set In/Out to Next Marked Range");
    bind("key-down--control--up", categoryAction("mark", expandMarkedRange), "Expand In/Out to Neighboring Marked Ranges");
    bind("key-down--control--down", categoryAction("mark", contractMarkedRange), "Contract In/Out from Neighboring Marked Ranges");
    bind("key-down--control--v", categoryAction("audio", globalVolumeMode), "Edit Global Audio Volume");
    bind("key-down--control--R", categoryAction("media", ~reloadInOut), "Reload In/Out Region");
    bind("key-down--control--C", categoryAction("media", ~loadCurrentSourcesChangedFrames), "Load Changed Frames of Current Sources");
    bind("key-down--control--f", categoryAction("rendering", frameWidth), "Frame Image Width");
    bind("key-down--down", categoryAction("transport", togglePlayFunc), "Toggle Play");
    bind("key-down--end", categoryAction("transport", ending), "Go to End of In/Out Region");
    bind("key-down--f", categoryAction("rendering", frameImage), "Frame Image in View");
    bind("key-down--f1", categoryAction("menubar", toggleMenuBar), "Toggle Menu Bar Visibility");
    bind("key-down--f2", categoryAction("timeline", toggleTimeline), "Toggle Heads-Up Timeline");
    bind("key-down--f3", categoryAction("timeline", toggleMotionScope), "Toggle Timeline Magnifier");
    bind("key-down--f4", categoryAction("info", toggleInfo), "Toggle Heads-Up Image Info");
    bind("key-down--f5", categoryAction("info", toggleColorInspector), "Toggle Heads-Up Color Inspector");
    bind("key-down--f6", categoryAction("rendering", toggleWipe), "Toggle Wipes");
    bind("key-down--f7", categoryAction("info", toggleInfoStrip), "Toggle Heads-Up Info Strip");
    bind("key-down--f8", categoryAction("info", toggleProcessInfo), "Toggle Heads-Up External Process Progress");
    bind("key-down--f11", categoryAction("info", toggleSourceDetails), "Toggle Heads-Up Source Details");
    bind("key-down--g", categoryAction("rendering", showChannel(2)), "Show Green Channel");
    bind("key-down--home", categoryAction("transport", beginning), "Go to Beginning of In/Out Range");
    bind("key-down--shift--home", categoryAction("rendering", resetAllColorParameters), "Reset All Color");
    bind("key-down--i", categoryAction("info", toggleInfo), "Toggle Heads-Up Image Info");
    bind("key-down--l", categoryAction("rendering", showChannel(5)), "Show Image Luminance");
    bind("key-down--left", categoryAction("transport", stepBackward1), "Move Back One Frame");
    bind("key-down--m", categoryAction("mark", toggleMark), "Toggle Mark At Frame");
    bind("key-down--n", categoryAction("rendering", toggleFilter), "Toggle Nearest Neighbor/Linear Filter");
    bind("key-down--p", categoryAction("rendering", togglePremult), "Toggle Premult Display");
    bind("key-down--page-down", categoryAction("mark", previousMarkedRange), "Set In/Out to Previous Marked Range");
    bind("key-down--page-up", categoryAction("mark", nextMarkedRange), "Set In/Out to Next Marked Range");
    bind("key-down--control--p", categoryAction("presentation", togglePresentationMode), "Toggle Presentation Mode");
    bind("key-down--r", categoryAction("rendering", showChannel(1)), "Show Red Channel");
    bind("key-down--right", categoryAction("transport", stepForward1), "Step Forward 1 Frame");
    bind("key-down--t", categoryAction("timeline", toggleTimeline), "Toggle Heads-Up Timeline");
    bind("key-down--tab", categoryAction("timeline", toggleTimeline), "Toggle Heads-Up Timeline");
    bind("key-down--up", categoryAction("transport", toggleForwardsBackwards), "Toggle Forward/Backward Playback");
    bind("key-down--v", categoryAction("rendering", enterDispGamma), "Enter Display Gamma");
    bind("key-down--|", categoryAction("mark", setInOutMarkedRange), "Set In/Out Range From Surrounding Marks");
    bind("key-down--~", categoryAction("timeline", toggleTimeline), "Toggle Timeline");
    bind("pointer--wheeldown", categoryAction("transport", stepForward1), "Step Forward 1 Frame");
    bind("pointer--wheelup", categoryAction("transport", stepBackward1), "Step Backward 1 Frame");
    bind("pointer-3--wheeldown", categoryAction("transport", stepForward10), "Step Forward 10 Frames");
    bind("pointer-3--wheelup", categoryAction("transport", stepBackward10), "Step Backward 10 Frames");
    bind("pointer-2-3--wheeldown", categoryAction("transport", stepForward100), "Step Forward 100 Frames");
    bind("pointer-2-3--wheelup", categoryAction("transport", stepBackward100), "Step Backward 100 Frames");
    bind("pointer--control--wheeldown", categoryAction("transport", stepForward10), "Step Forward 10 Frames");
    bind("pointer--control--wheelup", categoryAction("transport", stepBackward10), "Step Backward 10 Frames");
    bind("pointer--alt-control--wheeldown", categoryAction("transport", stepForward100), "Step Forward 100 Frames");
    bind("pointer--alt-control--wheelup", categoryAction("transport", stepBackward100), "Step Backward 100 Frames");
    bind("pointer-1--alt--drag", categoryAction("navigation", dragMoveLocked(false,)), "Translate View");
    bind("pointer-1--alt-shift--drag", categoryAction("navigation", dragMoveLocked(true,)), "Translate View");
    bind("pointer-1--alt--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-1--alt-shift--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-1--alt-control--drag", categoryAction("rendering", dragMoveLocked(false,)), "Translate View");
    bind("pointer-1--alt-shift-control--drag", categoryAction("rendering", dragMoveLocked(true,)), "Translate View");
    bind("pointer-1--alt-control--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-1--alt-shift-control--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-1--control--drag", categoryAction("rendering", dragZoom));
    bind("pointer-1--control--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-1--control-shift--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-1--drag", categoryAction("transport", dragScrub(false,)), "Scrub Frames");
    bind("pointer-1--push", categoryAction("tbd", beginScrub));
    bind("pointer-1--release", categoryAction("tbd", releaseScrub));
    bind("pointer-1--double", categoryAction("tbd",  doubleClick));
    bind("pointer-1-2--alt--drag", categoryAction("rendering", dragZoom), "Zoom View");
    bind("pointer-1-2--alt--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-1-2--alt-shift--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-2--alt--drag", categoryAction("rendering", dragMoveLocked(false,)), "Translate View");
    bind("pointer-2--alt-shift--drag", categoryAction("rendering", dragMoveLocked(true,)), "Translate View");
    bind("pointer-2--alt--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-2--alt-shift--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-2--control--drag", categoryAction("rendering", dragZoom), "Zoom View");
    bind("pointer-2--control--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-2--control-shift--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-2--drag", categoryAction("rendering", dragMoveLocked(false,)), "Translate View");
    bind("pointer-2--shift--drag", categoryAction("rendering", dragMoveLocked(true,)), "Translate View");
    bind("pointer-2--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-2--shift--push", categoryAction("rendering", beginMoveOrZoom));
    bind("pointer-3--push", categoryAction("tbd", popupMenu(,nil)), "Popup Menu");
    ...
    //
    bind("pointer-1--control-shift--push", categoryAction("transport", beginScrub));
    bind("pointer-1--control-shift--drag", categoryAction("transport", dragScrub(true,)), "Scrub Frames");
    bind("pointer-1--control-shift--release", categoryAction("transport", releaseScrub));
    bind("stylus-pen--control-shift--push", categoryAction("transport", beginScrub));
    bind("stylus-pen--control-shift--drag", categoryAction("transport", dragScrub(true,)), "Scrub Frames");
    bind("stylus-pen--control-shift--release", categoryAction("transport", releaseScrub));

    bind("pointer-1--shift--push", categoryAction("info", \: (void; Event event)
    {
    ...
    bind("stylus-pen--shift--push", categoryAction("info", \: (void; Event event)
    {
        toggleColorInspector();
        event.reject();  // it will find the bindings in the inspector
    }),
    ...
    bind("stylus-pen--alt--drag", categoryAction("rendering", dragMoveLocked(false,)), "Translate View");
    bind("stylus-pen--alt-shift--drag", categoryAction("rendering", dragMoveLocked(true,)), "Translate View");
    bind("stylus-pen--alt--push", categoryAction("rendering", beginMoveOrZoom));
    bind("stylus-pen--alt-shift--push", categoryAction("rendering", beginMoveOrZoom));
    bind("stylus-pen--alt-control--drag", categoryAction("rendering", dragMoveLocked(false,)), "Translate View");
    bind("stylus-pen--alt-shift-control--drag", categoryAction("rendering", dragMoveLocked(true,)), "Translate View");
    bind("stylus-pen--alt-control--push", categoryAction("rendering", beginMoveOrZoom));
    bind("stylus-pen--alt-shift-control--push", categoryAction("rendering", beginMoveOrZoom));
    bind("stylus-pen--control--drag", categoryAction("rendering", dragZoom));
    bind("stylus-pen--control--push", categoryAction("rendering", beginMoveOrZoom));
    bind("stylus-pen--control-shift--push", categoryAction("rendering", beginMoveOrZoom));
    bind("stylus-pen--drag", categoryAction("transport", dragScrub(false,)), "Scrub Frames");
    bind("stylus-pen--push", categoryAction("transport", beginScrub));
    bind("stylus-pen--release", categoryAction("transport", releaseScrub));
    ...
    bind("view-resized", categoryAction("rendering", viewResized), "RV View Resized");
    bind("margins-changed", categoryAction("rendering", marginsChanged), "RV View Margins Changed");
    bind("state-initialized", stateInitialized, "RVUI State Initialized");

    bind("key-down--keypad-enter", categoryAction("transport", enterFrame), "Set Frame Number Using Keyboard");
    bindRegex("default", "global", "key-down--keypad-[0-9.].*", categoryAction("transport", enterFrame));
    ...
    bindRegex("default", "global", "dragdrop--.*enter", categoryAction("media", dragEnter));
    bindRegex("default", "global", "dragdrop--.*move", categoryAction("media", dragShow));
    bindRegex("default", "global", "dragdrop--.*leave", categoryAction("media", dragLeave));
    bindRegex("default", "global", "dragdrop--.*release", categoryAction("media", dragRelease));

    //
    //  Hack to "scrub" float parameters
    //

    bind("key-down--e", categoryAction("media", exposureMode), "Edit Current Source Relative Exposure");
    bind("key-down--S", categoryAction("media", saturationMode), "Edit Current Source Saturation");
    bind("key-down--h", categoryAction("media", hueMode), "Edit Current Source Hue");
    bind("key-down--y", categoryAction("media", gammaMode), "Edit Current Source Gamma");
    bind("key-down--k", categoryAction("media", contrastMode), "Edit Current Source Contrast");
    bind("key-down--B", categoryAction("rendering", brightnessMode), "Edit Display Brightness");
    bind("default", "paramscrub", "pointer-1--push", categoryAction("tbd", beginParamScrub));
    bind("default", "paramscrub", "pointer-1--drag", categoryAction("tb", dragParamScrub), "Scrub Modify");
    bind("default", "paramscrub", "pointer-1--release", categoryAction("tbd", releaseParam));
    bind("default", "paramscrub", "stylus-pen--push", categoryAction("tbd", beginParamScrub));
    bind("default", "paramscrub", "stylus-pen--drag", categoryAction("tbd", dragParamScrub), "Scrub Modify");
    bind("default", "paramscrub", "stylus-pen--release", categoryAction("tbd", releaseParam));
    bind("default", "paramscrub", "key-down--?", categoryAction("tbd", helpParam), "Help on Edit");
    bind("default", "paramscrub", "key-down--R", categoryAction("tbd", resetParam), "Reset Edit to Default");
    bind("default", "paramscrub", "key-down--delete", categoryAction("tbd", resetParam), "Reset Edit to Default");
    bind("default", "paramscrub", "key-down--backspace", categoryAction("tbd", resetParam), "Reset Edit to Default");
    bind("default", "paramscrub", "key-down--s", categoryAction("tbd", selectParamTile), "Select Tile for Param Editing");
    bind("default", "paramscrub", "key-down--r", categoryAction("tbd", setParamChannel(0,)), "Edit Red Channel");
    bind("default", "paramscrub", "key-down--g", categoryAction("tbd", setParamChannel(1,)), "Edit Green Channel");
    bind("default", "paramscrub", "key-down--b", categoryAction("tbd", setParamChannel(2,)), "Edit Blue Channel");
    bind("default", "paramscrub", "key-down--c", categoryAction("tbd", setParamChannel(-1,)), "Edit All Channels");
    bind("default", "paramscrub", "key-down--l", categoryAction("tbd", toggleParamLocked), "Lock/Unlock Param Edit Mode");
    bind("default", "paramscrub", "key-down--=", categoryAction("tbd", incrementParam), "Edit Increment");
    bind("default", "paramscrub", "key-down---", categoryAction("tbd", decrementParam), "Edit Decrement");
    bind("default", "paramscrub", "key-down--+", categoryAction("tbd", incrementParam), "Edit Increment");
    bind("default", "paramscrub", "key-down--_", categoryAction("tbd", decrementParam), "Edit Decrement");
    bind("default", "paramscrub", "key-down--enter", categoryAction("tbd", enterParam), "Edit Enter Value Directly");
    bind("default", "paramscrub", "key-down--keypad-enter", categoryAction("tbd", enterParam), "Edit Enter Value Directly");
    bind("default", "paramscrub", "pointer--wheelup", categoryAction("tbd", incrementParam), "Edit Increment");
    bind("default", "paramscrub", "pointer--wheeldown", categoryAction("tbd", decrementParam), "Edit Decrement");
    bindRegex("default", "paramscrub", "key-down--(keypad-)?[0-9.].*", categoryAction("tbd", enterParam), "Edit Enter Value Directly and Self Insert");
    bindRegex("default", "paramscrub", "key-down-- ", categoryAction("tbd", releaseParamForce));
    bindRegex("default", "paramscrub", "key-down--escape", categoryAction("tbd", releaseParamForce));
    bindRegex("default", "paramscrub", "key-down--q", categoryAction("tbd", releaseParamForce));
    bindRegex("default", "paramscrub", "key-down.*", categoryAction("tbd", releaseParam));

    bind("default", "textentry", "key-down--enter", categoryAction("tbd", commitEntry));
    bind("default", "textentry", "key-down--keypad-enter", categoryAction("tbd", commitEntry));
    bind("default", "textentry", "key-down--backspace", categoryAction("tbd", backwardDeleteChar));
    bind("default", "textentry", "key-down--delete", categoryAction("tbd", backwardDeleteChar));
    bind("default", "textentry", "key-down--escape", categoryAction("tbd", cancelEntry));
    bind("default", "textentry", "key-down--control--a", categoryAction("tbd", killAllText));
    bind("default", "textentry", "key-down--meta--a", categoryAction("tbd", killAllText));
    bindRegex("default", "textentry", "^key-down--..+", categoryAction("tbd", ignoreEntry));
    bindRegex("default", "textentry", "^key-down.*", categoryAction("tbd", selfInsert));
    bindRegex("default", "textentry", "^pointer-.*--push", categoryAction("tbd", cancelEntry));

    bind("default", "stereo", "key-down--a", categoryAction("rendering", setStereo("anaglyph")), "Anaglyph Mode");
    bind("default", "stereo", "key-down--l", categoryAction("rendering", setStereo("lumanaglyph")), "Luminance Anaglyph Mode");
    bind("default", "stereo", "key-down--d", categoryAction("rendering", setStereo("checker")), "Checked Stereo Mode");
    bind("default", "stereo", "key-down--k", categoryAction("rendering", setStereo("scanline")), "Scanline Stereo Mode");
    bind("default", "stereo", "key-down--s", categoryAction("rendering", setStereo("pair")), "Side-by-Side Stereo Mode");
    bind("default", "stereo", "key-down--p", categoryAction("rendering", setStereo("pair")), "Side-by-Side Stereo Mode");
    bind("default", "stereo", "key-down--m", categoryAction("rendering", setStereo("mirror")), "Mirrored Side-by-Side Stereo Mode");
    bind("default", "stereo", "key-down--z", categoryAction("rendering", setStereo("hsqueezed")), "Horizontal Squeezed Stereo Mode");
    bind("default", "stereo", "key-down--v", categoryAction("rendering", setStereo("vsqueezed")), "Vertical Squeezed Stereo Mode");
    bind("default", "stereo", "key-down--h", categoryAction("rendering", setStereo("hardware")), "Hardware Stereo Mode");
    bind("default", "stereo", "key-down--,", categoryAction("rendering", setStereo("left")), "Left Eye Only Stereo Mode");
    bind("default", "stereo", "key-down--.", categoryAction("rendering", setStereo("right")), "Right Eye Only Stereo Mode");
    bind("default", "stereo", "key-down--<", categoryAction("rendering", setStereo("left")), "Left Eye Only Stereo Mode");
    bind("default", "stereo", "key-down-->", categoryAction("rendering", setStereo("right")), "Right Eye Only Stereo Mode");
    bind("default", "stereo", "key-down--O", categoryAction("rendering", setStereo("off")), "Stereo Off");
    bind("default", "stereo", "key-down--S", categoryAction("rendering", toggleSwapEyes), "Swap Eyes");
    bind("default", "stereo", "key-down--o", categoryAction("rendering", stereoOffsetMode), "Edit Stereo Offset");
    bind("default", "stereo", "key-down--r", categoryAction("rendering", stereoROffsetMode), "Edit Right-Eye-Only Stereo Offset");
    bind("default", "stereo", "key-down--c", categoryAction("media", sourceStereoOffsetMode), "Edit Source/Clip Stereo Offset");
    bind("default", "stereo", "key-down--R", categoryAction("media", sourceStereoROffsetMode), "Edit Source/Clip Right-Eye-Only Stereo Offset");
    bind("default", "stereo", "key-down--/", categoryAction("rendering", resetStereoOffsets), "Reset Stereo Offsets");
    bind("default", "stereo", "key-down--alt--s", categoryAction("rendering", releaseStereo), "Turn Off Stereo Keys");

    bind("key-down--alt--s", categoryAction("rendering", \: (void; Event ev)
    {
    ...
    bind("default", "nudge", "key-down--right", categoryAction("media", nudge(-.01,0,1)), "Nudge Right");
    bind("default", "nudge", "key-down--left", categoryAction("media", nudge(.01,0,1)), "Nudge Left");
    bind("default", "nudge", "key-down--up", categoryAction("media", nudge(0,-.01,1)), "Nudge Up");
    bind("default", "nudge", "key-down--down", categoryAction("media", nudge(0,.01,1)), "Nudge Down");
    bind("default", "nudge", "key-down--control--right", categoryAction("media", nudge(-0.001,0,1)), "Nudge Right Tiny");
    bind("default", "nudge", "key-down--control--left", categoryAction("media", nudge(0.001,0,1)), "Nudge Left Tiny");
    bind("default", "nudge", "key-down--control--up", categoryAction("media", nudge(0,-.001,1)), "Nudge Up Tiny");
    bind("default", "nudge", "key-down--control--down", categoryAction("media", nudge(0,.001,1)), "Nudge Down Tiny");
    bind("default", "nudge", "key-down--shift--right", categoryAction("media", nudge(-.1,0,1)), "Nudge Right Big");
    bind("default", "nudge", "key-down--shift--left", categoryAction("media", nudge(.1,0,1)), "Nudge Left Big");
    bind("default", "nudge", "key-down--shift--up", categoryAction("media", nudge(0,-.1,1)), "Nudge Up Big");
    bind("default", "nudge", "key-down--shift--down", categoryAction("media", nudge(0,.1,1)), "Nudge Down Big");
    bind("default", "nudge", "key-down--z", categoryAction("media", nudge(0,0,1.1)), "Nudge Zoom-In");
    bind("default", "nudge", "key-down--control--z", categoryAction("media", nudge(0,0,1.01)), "Nudge Big Zoom-Out");
    bind("default", "nudge", "key-down--alt--n", categoryAction("media", releaseNudge), "Turn Off Nudge Keys");

    bind("key-down--alt--n", categoryAction("media", \: (void; Event ev)
    {
